...
const invalidConfirmation = local.form.field.confirmed.invalid;
...
const confirmed = local.form.field.confirmed.name;
...
export default Yup.object().shape({
  ...
  [confirmed]: Yup.string()
    .oneOf([Yup.ref(password), null], invalidConfirmation)
    .required(requiredField),
});
